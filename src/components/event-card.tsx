...
export default function EventCard({ event }: EventCardProps) {
  ...
  return (
    ...
    >
      <section className="flex flex-col flex-1 w-full h-full bg-white/[3%] rounded-xl overflow-hidden relative  state-effects ">
        <Image
        ...
        <section className="absolute flex flex-col justify-center items-center left-[12px] top-[12px] h-[45px] w-[45px] bg-black/30 rounded-md">
          <p className="text-xl font-bold -mb-[5px]">
            {
              // turn date into day of the month with leading 0
              new Date(event.date)
